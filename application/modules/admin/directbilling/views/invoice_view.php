...
<?php
$order_date=$order_details->bill_date;
    ...
    <div style="text-align: center">
        <img src="<?php base_url() ?>assets/logo.png" class="logo"> <br />
         <b style="font-size:14px">MOBI TRADOS</b> <br />
           ...
           Ph: 04651- 216156 | Email : mobitrados@gmail.com | Web: www.mobitrados.com
           <br />
           <br />
         ...
         <table class="tb1">
           <tr>
             <td style="width: 36%">
               <b>Bill Number :  <?= $order_details->bill_number ?></b> <br />
               Bill Date : <?= $order_date ?> <br />
               Invoice Date : <?= $inv_date?> <br />
               GST NO : 33ABPFM4585Q1ZB <br />
             </td>
             <td style="width: 32%">
               <b>Billed To</b>  <br />
               <b> <?= $order_details->customer_name ?> </b> <br />
               <?= nl2br($order_details->customer_place) ?> <br />
               Mobile: <?= nl2br($order_details->customer_mobile) ?> <br />
