...
<nav aria-label="breadcrumb" class="main-breadcrumb">
	<ol class="breadcrumb breadcrumb-style2">
		...
		<li class="breadcrumb-item active" aria-current="page">Cancellation / Refund</li>
	</ol>
</nav>
<?php
...
?>
  ...
  ?>
            <label>Update Cancellation / Refund Policy</label>
...
function save_terms()
{
    ...
    $.ajax({
	   type: "POST",
	   url: '<?php echo admin_url() ?>manage_app/save_refund',
	   data: formData,
		 processData: false,
		 contentType: false,
