			...
			<div class="container">
				<div class="row justify-content-between align-items-center">
					<div class="offset-xl-12 offset-lg-12 col-xl-12 col-lg-12">
						...
						<div class="col-lg-4 mb-4 mb-lg-0"><img class="img-fluid w-100 px-lg-5" src="https://mobitrados.com/assets/website/img/objects.svg" alt=""></div>
						<div class="col-lg-8">

							

							<h4> 19/20H Kattaikadu Ammandivilai  <Br>
                            Kaniyakumari - 629204 <Br>
                            +91 7358167613 <Br>
                            mobitrados@gmail.com <Br>
                            www.mobitrados.com </h4>
