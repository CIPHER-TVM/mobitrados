...
<div class="modal fade" id="verticalModal" tabindex="-1" role="dialog" aria-labelledby="verticalModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h6 class="modal-title" id="verticalModalLabel"><strong> <u>Add offerd products </strong> </u></h6>
  ...
  Upload size  1920*720
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-4">
                   ...
                   <input type="text" class="form-control form-control-sm"  name="stock" id="stock" readonly/>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <label style="font-size : 15px">Select Banner <span class="star">*</span></label> <br />
	          ...
	          <div id="crude">
	            <button onclick="save_offer(1)" type="button" class="btn btn-primary btn-xs">Save</button>
	          </div>
	        </div>
				</div>
		</div>
...
var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>',
	...
	$(document).ready(function() {
		...
		table = $('#example').DataTable({
			...
			'ajax': {
					url: '<?php echo admin_url() ?>manage_app/get_offers',
					type: 'POST',
...
function save_offer(crude=1)
{
  ...
  formData.append('crude', crude);
	  $.ajax({
	   type: "POST",
	   url: '<?php echo admin_url() ?>manage_app/save_offer',
     data: formData,
		 processData: false,
		 contentType: false,
...
{
  if(dstatus==1) msg="Offer activated successfully"; else msg="offer deactivated successfully";
  let ajaxval = {
    id: id,
    dstatus:dstatus,
    [csrfName]: csrfHash
...
{
	 if(type==1) $('#crude').html('<button onclick="save_offer(1)" type="button" class="btn btn-primary btn-xs">Save</button>');
