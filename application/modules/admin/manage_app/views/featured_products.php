		...
		<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h6 class="modal-title" id="verticalModalLabel"><strong> <u>Add Featured Products </strong> </u></h6>
            ...
            <div class="form-group">
	          ...
	          <div id="crude">
	            <button onclick="save_offer(3)" type="button" class="btn btn-primary btn-xs">Save</button>
	          </div>
	        </div>
				</div>
		</div>
...
var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>',
	...
	$(document).ready(function() {
		...
		table = $('#example').DataTable({
			...
			'ajax': {
					url: '<?php echo admin_url() ?>manage_app/get_offers/3',
					type: 'POST',
...
{
	 if(type==1) $('#crude').html('<button onclick="save_offer(3)" type="button" class="btn btn-primary btn-xs">Save</button>');
